...
Add `@gowaplatform/n8n-openapi-node` as dependency

```bash
npm install @gowaplatform/n8n-openapi-node
# OR
pnpm add @gowaplatform/n8n-openapi-node
# OR
yarn add @gowaplatform/n8n-openapi-node
```
...
import {N8NPropertiesBuilder, N8NPropertiesBuilderConfig} from '@gowaplatform/n8n-openapi-node';
...
```typescript
import {IResourceParser} from '@gowaplatform/n8n-openapi-node';
...
import {DefaultResourceParser} from '@gowaplatform/n8n-openapi-node';
...
Find real example in [@gowaplatform/n8n-nodes-gowapi](https://github.com/gowaplatform/n8n-nodes-gowapi) repository.
...
```typescript
import {IOperationParser} from '@gowaplatform/n8n-openapi-node';
...
```typescript
import {DefaultOperationParser} from '@gowaplatform/n8n-openapi-node';
...
```typescript
import {Override} from '@gowaplatform/n8n-openapi-node';
...
Check [ChatWoot node](https://github.com/gowaplatform/n8n-nodes-chatwoot)
for an example.
